                    ...
                    if (x == 0)
                    {
                        ...
                        while (Game.isOpen())
                        {
                            ...
                            if (GG.perehod(80, 800)) {
                                ...
                                cat.npc1_sprite.setPosition(-205, -300);
                            ...
                            if (GG.granics(80, 800)) {
                                ...
                                Game.draw(Fon);
                                Game.draw(GG.sprite);
                                npc.npc_sprite.setPosition(500, 300);//
                                Game.draw(npc.npc_sprite);
                                cat.npc1_sprite.setPosition(1400, 370);
                                Game.draw(cat.npc1_sprite);
                            }

                            lol::Textbox Box(100, 500, 800, 300, "Box1.png", "HELP ME");
                            vector<string> talk = { "Hello", "...", "Im not Fine",  "Im dead", "Because Matan" };

                            float k = 0;
                            if ((Keyboard::isKeyPressed(Keyboard::E)) && (GG.m_x <= npc.npc_x + 100) && (GG.m_y <= npc.npc_y + 100))
                            {
                            ...
                            if ((Keyboard::isKeyPressed(Keyboard::E)) && ((cat.npc_x2 + 70) >= GG.m_x) && ((cat.npc_y2 + 70) >= GG.m_y)) {
                                cat.said("meow.wav");
